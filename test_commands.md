...
Build `e984f9f1`. Argument order differs by script kind, because the apply-group scripts carry the
...
reproduction-only since e984f9f1 and must not be used for new runs. `--min-edge` existed only between `93b8e45a` and
...
mkdir -p build_e984f9f1 && cd build_e984f9f1
...
```bash
sbatch -w super001 benchmark/benchmark_exclusion_group.sh e984f9f1 0.40 0.3333 0.995 0
sbatch -w super001 benchmark/benchmark_inclusion_group.sh e984f9f1 0.40 0.3333 0.995 0
sbatch -w super001 cami2/cami2_strain_madness_group.sh    e984f9f1 0.40 0.3333 0.995 0
sbatch -w super001 cami2/cami2_marine_group.sh            e984f9f1 0.40 0.3333 0.995 0
sbatch -w super001 cami2/cami2_plant_associated_group.sh  e984f9f1 0.40 0.3333 0.995 0
sbatch -w super001 cami2/cami2_clinical_pathogen_group.sh e984f9f1 0.40 0.3333 0.995 0
```
...
```bash
sbatch -w super001 --cpus-per-task=4  cami2/cami2_strain_madness_group.sh e984f9f1 0.40 0.3333 0.995 0 4  16
sbatch -w super001 --cpus-per-task=16 cami2/cami2_strain_madness_group.sh e984f9f1 0.40 0.3333 0.995 0 16 16
sbatch -w super001 --cpus-per-task=64 cami2/cami2_strain_madness_group.sh e984f9f1 0.40 0.3333 0.995 0 64 16
```

Tags: `e984f9f1_0.40_0.3333_q0.995_p16_t4`, `_p16_t16`, `_p16` (64 threads is the default, so no
...
# --min-overlap-ratio
for r in 0.3 0.5;       do sbatch -w super001 $G1 e984f9f1 $r   0.3333 0.995 0; sbatch -w super001 $G2 e984f9f1 $r   0.3333 0.995 0; done
# --weak-band-ratio
for b in 0.20 0.50;     do sbatch -w super001 $G1 e984f9f1 0.40 $b     0.995 0; sbatch -w super001 $G2 e984f9f1 0.40 $b     0.995 0; done
# --max-kmer-quantile
for q in 0.990 0.999;   do sbatch -w super001 $G1 e984f9f1 0.40 0.3333 $q    0; sbatch -w super001 $G2 e984f9f1 0.40 0.3333 $q    0; done
# --common-kmer-span
for s in 1 2;           do sbatch -w super001 $G1 e984f9f1 0.40 0.3333 0.995 $s; sbatch -w super001 $G2 e984f9f1 0.40 0.3333 0.995 $s; done
```
...
```bash
sbatch -w super001 benchmark/benchmark_exclusion_metabuli_group.sh e984f9f1 0.40 0.3333 0.995 0 2 0.15
sbatch -w super001 benchmark/benchmark_inclusion_metabuli_group.sh e984f9f1 0.40 0.3333 0.995 0 2 0.15
sbatch -w super001 cami2/cami2_metabuli_strain_madness_group.sh    e984f9f1 0.40 0.3333 0.995 0 2 0.15
sbatch -w super001 cami2/cami2_metabuli_marine_group.sh            e984f9f1 0.40 0.3333 0.995 0 2 0.15
sbatch -w super001 cami2/cami2_metabuli_plant_associated_group.sh  e984f9f1 0.40 0.3333 0.995 0 2 0.15
sbatch -w super001 cami2/cami2_metabuli_clinical_pathogen_group.sh e984f9f1 0.40 0.3333 0.995 0 2 0.15
```
...
```bash
sbatch -w super001 cami2/cami2_metabuli_strain_madness_group.sh e984f9f1 0.40 0.3333 0.995 0 2 0.15 4 16
```
...
```bash
for w in 0 1; do
  sbatch -w super001 benchmark/benchmark_exclusion_metabuli_group.sh e984f9f1 0.40 0.3333 0.995 0 $w 0.15
  sbatch -w super001 benchmark/benchmark_inclusion_metabuli_group.sh e984f9f1 0.40 0.3333 0.995 0 $w 0.15
  sbatch -w super001 cami2/cami2_metabuli_strain_madness_group.sh    e984f9f1 0.40 0.3333 0.995 0 $w 0.15
  sbatch -w super001 cami2/cami2_metabuli_marine_group.sh            e984f9f1 0.40 0.3333 0.995 0 $w 0.15
  sbatch -w super001 cami2/cami2_metabuli_plant_associated_group.sh  e984f9f1 0.40 0.3333 0.995 0 $w 0.15
  sbatch -w super001 cami2/cami2_metabuli_clinical_pathogen_group.sh e984f9f1 0.40 0.3333 0.995 0 $w 0.15
done
```
...
for s in benchmark/benchmark_exclusion_kraken2_group.sh \
  ...
  sbatch -w super001 $s e984f9f1 0.40 0.3333 0.995 0
done
```
...
```bash
sbatch -w super001 benchmark/benchmark_exclusion_metabuli_group.sh e984f9f1 0.40 0.3333 0.995 1 2 0.15
```
